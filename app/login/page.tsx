        ...
        <div className="bg-white rounded-2xl shadow-2xl border-2 border-gray-100 p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button 
              ...
              disabled={isSubmitting}
              className="flex items-center justify-center space-x-2 px-4 py-3 bg-gray-900 hover:bg-gray-800 border-2 border-gray-900 rounded-xl font-medium text-white transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
